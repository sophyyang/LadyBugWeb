	...
	<body>
		...
		<div id="show-status" class="content scaffold-show" role="main">
			...
			<ol class="property-list status">
				...
				<g:if test="${statusInstance?.categoryId}">
				<li class="fieldcontain">
					<span id="categoryId-label" class="property-label"><g:message code="status.categoryId.label" default="Category Id" /></span>
					
						<span class="property-value" aria-labelledby="categoryId-label"><g:fieldValue bean="${statusInstance}" field="categoryId"/></span>
				...
				<g:if test="${statusInstance?.iOrder}">
				<li class="fieldcontain">
					<span id="iOrder-label" class="property-label"><g:message code="status.iOrder.label" default="IO rder" /></span>
					
						<span class="property-value" aria-labelledby="iOrder-label"><g:fieldValue bean="${statusInstance}" field="iOrder"/></span>
